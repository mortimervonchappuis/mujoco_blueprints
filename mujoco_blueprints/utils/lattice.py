...
a convenience object to help generate copies of a :class:`MoveableThing <mujoco_blueprints.thing.moveable.MoveableThing>` 
arranged in a grid. Attaching a Lattice to any :class:`NodeThing <mujoco_blueprints.thing.node.NodeThing>` results 
...
the Lattice, the last axes are retrieved fully. Indexed Lattices utilize a :class:`LatticeView <mujoco_blueprints.utils.view.LatticeView>` 
...
class Lattice(blue.LatticeType):
	...
	Lattices are not mujoco objects but mujoco_blueprints utility.
	"""
	__RESERVED = {'name', 
		      '_directions', 
		      '_repetitions', 
