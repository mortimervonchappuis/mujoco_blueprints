"""
.. note::
	If you found yourself here not being a dev, you should probably :mod:`skip this section <mujoco_blueprints.world>` from or 
...
To prevent this, mujoco_blueprints is type safe in attributes (which is most of the user accessable interface). 
...
proper Thing class.
Every Thing class in mujoco_blueprints must inherit (as its first base class) from a Type class in this module.
...
attributes used to translate back and forth between mujoco xml and mujoco_blueprints.
"""
...
class PathType(ABC):
	...
	description see :class:`mujoco_blueprints.tendon.Path`.
	"""
...
class FunctionHandleType(ABC):
	...
	description see :class:`mujoco_blueprints.utils.view.FunctionHandle`.
	"""
...
class ViewType(ABC):
	...
	description see :class:`mujoco_blueprints.utils.view.View`.
	"""
...
class AllViewType(ViewType):
	...
	description see :class:`mujoco_blueprints.utils.view.AllView`.
	"""
...
class LatticeType(ABC):
	...
	description see :class:`mujoco_blueprints.utils.lattice.Lattice`.
	"""
...
class LatticeViewType(ABC):
	...
	description see :class:`mujoco_blueprints.utils.view.LatticeView`.
	"""
...
class ThingType(ABC):
	...
	description see :class:`mujoco_blueprints.thing.base.BaseThing`.
	"""
...
class NodeThingType(ThingType):
	...
	description see :class:`mujoco_blueprints.thing.node.NodeThing`.
	"""
...
class MoveableThingType(ThingType):
	...
	description see :class:`mujoco_blueprints.thing.moveable.MoveableThing`.
	"""
	_NEW_STEP_CACHE     = {'pos', 
			       'rotation_matrix', 
...
class ColoredThingType(ThingType):
	...
	description see :class:`mujoco_blueprints.thing.colored.ColoredThing`.
	"""
...
class CyclicalThingType(ThingType):
	...
	description see :class:`mujoco_blueprints.thing.cyclical.CyclicalThing`.
	"""
...
class UniqueThingType(ThingType):
	...
	description see :class:`mujoco_blueprints.thing.unique.UniqueThing`.
	"""
...
class FocalThingType(ThingType):
	...
	description see :class:`mujoco_blueprints.thing.unique.FocalThing`.
	"""
...
class CacheType(UniqueThingType):
	...
	description see :class:`mujoco_blueprints.cache.BaseCache`.
	"""
...
class MeshCacheType(CacheType):
	...
	description see :class:`mujoco_blueprints.cache.MeshCache`.
	"""
...
class AssetType(UniqueThingType):
	...
	description see :class:`mujoco_blueprints.assets.BaseAsset`.
	"""
...
class TextureAssetType(AssetType):
	...
	description see :class:`mujoco_blueprints.assets.TextureAsset`.
	"""
...
class TextureType(ThingType):
	...
	description see :class:`mujoco_blueprints.texture.BaseTexture`.
	"""
...
class PlaneTextureType(TextureType):
	...
	"""
	This abstract base class is a used to represent the Texture class in type hints. For a detailed
	description see :class:`mujoco_blueprints.texture.Plane`.
	"""
...
class BoxTextureType(TextureType):
	...
	"""
	This abstract base class is a used to represent the Texture class in type hints. For a detailed
	description see :class:`mujoco_blueprints.texture.Box`.
	"""
...
class SkyboxTextureType(BoxTextureType):
	...
	"""
	This abstract base class is a used to represent the Texture class in type hints. For a detailed
	description see :class:`mujoco_blueprints.texture.Skybox`.
	"""
...
class MaterialAssetType(AssetType, ColoredThingType):
	...
	description see :class:`mujoco_blueprints.assets.MaterialAsset`.
	"""
...
class MaterialType(NodeThingType):
	...
	description see :class:`mujoco_blueprints.Material`.
	"""
...
class MeshAssetType(MoveableThingType, AssetType):
	...
	description see :class:`mujoco_blueprints.assets.MeshAsset`.
	"""
...
class WorldType(NodeThingType):
	...
	description see :class:`mujoco_blueprints.world.World`.
	"""
...
class BodyType(NodeThingType):
	...
	description see :class:`mujoco_blueprints.body.Body`.
	"""
...
class PlaceholderType(MoveableThingType):
	...
	description see :class:`mujoco_blueprints.placeholder.Placeholder`.
	"""
...
class GeomType(MoveableThingType, ColoredThingType, NodeThingType):
	...
	description see :class:`mujoco_blueprints.geoms.BaseGeom`.
	"""
...
class CapsuleGeomType(GeomType, TubeType):
	...
	description see :class:`mujoco_blueprints.geoms.Capsule`.
	"""
...
class CylinderGeomType(GeomType, TubeType):
	...
	description see :class:`mujoco_blueprints.geoms.Cylinder`.
	"""
...
class BoxGeomType(GeomType, TubeType):
	...
	description see :class:`mujoco_blueprints.geoms.Box`.
	"""
...
class PlaneGeomType(GeomType):
	...
	description see :class:`mujoco_blueprints.geoms.Plane`.
	"""
...
class SphereGeomType(GeomType):
	...
	description see :class:`mujoco_blueprints.geoms.Sphere`.
	"""
...
class EllipsoidGeomType(GeomType):
	...
	description see :class:`mujoco_blueprints.geoms.Ellipsoid`.
	"""
...
class MeshGeomType(GeomType):
	...
	description see :class:`mujoco_blueprints.geoms.Mesh`.
	"""
...
class HFieldGeomType(GeomType):
	...
	description see :class:`mujoco_blueprints.geoms.Hfield`.
	"""
...
class SiteType(MoveableThingType, NodeThingType):
	...
	description see :class:`mujoco_blueprints.sites.BaseSite`.
	"""
...
class CapsuleSiteType(TubeType, SiteType):
	...
	description see :class:`mujoco_blueprints.sites.Capsule`.
	"""
...
class CylinderSiteType(TubeType, SiteType):
	...
	description see :class:`mujoco_blueprints.sites.Cylinder`.
	"""
...
class BoxSiteType(TubeType, SiteType):
	...
	description see :class:`mujoco_blueprints.sites.Box`.
	"""
...
class SphereSiteType(SiteType):
	...
	description see :class:`mujoco_blueprints.sites.Sphere`.
	"""
...
class EllipsoidSiteType(SiteType):
	...
	description see :class:`mujoco_blueprints.sites.Ellipsoid`.
	"""
...
class JointType(NodeThingType):
	...
	description see :class:`mujoco_blueprints.joints.BaseJoint`.
	"""
...
class HingeType(JointType):
	...
	description see :class:`mujoco_blueprints.joints.Hinge`.
	"""
...
class SlideType(JointType):
	...
	description see :class:`mujoco_blueprints.joints.Slide`.
	"""
...
class BallType(JointType):
	...
	description see :class:`mujoco_blueprints.joints.Ball`.
	"""
...
class FreeType(JointType):
	...
	description see :class:`mujoco_blueprints.joints.Free`.
	"""
...
class SensorType(ThingType):
	...
	description see :class:`mujoco_blueprints.sensors.BaseSensor`.
	"""
...
class SiteSensorType(SensorType):
	...
	description see :class:`mujoco_blueprints.sensors.SiteSensor`.
	"""
...
class JointSensorType(SensorType):
	...
	description see :class:`mujoco_blueprints.sensors.JointSensor`.
	"""
...
class ActuatorSensorType(SensorType):
	...
	description see :class:`mujoco_blueprints.sensors.ActuatorSensor`.
	"""
...
class TendonType(FocalThingType):
	...
	"""
	This abstract base class is a used to represent the Tendon class in type hints. For a detailed
	description see :class:`mujoco_blueprints.tendon.Tendon`.
	"""
...
class InfoLaserType(SiteSensorType):
	...
	description see :class:`mujoco_blueprints.sensors.InfoLaser`.
	"""
...
class ActuatorType(CyclicalThingType, NodeThingType):
	...
	description see :class:`mujoco_blueprints.actuators.BaseActuator`.
	"""
...
class PositionType(ActuatorType):
	...
	"""
	This abstract base class is a used to represent the Actuator class in type hints. For a detailed
	description see :class:`mujoco_blueprints.actuators.Position`.
	"""
...
class VelocityType(ActuatorType):
	...
	"""
	This abstract base class is a used to represent the Actuator class in type hints. For a detailed
	description see :class:`mujoco_blueprints.actuators.Velocity`.
	"""
...
class IntVelocityType(ActuatorType):
	...
	"""
	This abstract base class is a used to represent the Actuator class in type hints. For a detailed
	description see :class:`mujoco_blueprints.actuators.IntVelocity`.
	"""
...
class DamperType(ActuatorType):
	...
	"""
	This abstract base class is a used to represent the Actuator class in type hints. For a detailed
	description see :class:`mujoco_blueprints.actuators.Damper`.
	"""
...
class CylinderType(ActuatorType):
	...
	"""
	This abstract base class is a used to represent the Actuator class in type hints. For a detailed
	description see :class:`mujoco_blueprints.actuators.Cylinder`.
	"""
...
class MuscleType(ActuatorType):
	...
	"""
	This abstract base class is a used to represent the Actuator class in type hints. For a detailed
	description see :class:`mujoco_blueprints.actuators.Muscle`.
	"""
...
class AdhesionType(ActuatorType):
	...
	"""
	This abstract base class is a used to represent the Actuator class in type hints. For a detailed
	description see :class:`mujoco_blueprints.actuators.Adhesion`.
	"""
...
class LightType(CyclicalThingType, MoveableThingType):
	...
	description see :class:`mujoco_blueprints.light.Light`.
	"""
...
class CameraType(CyclicalThingType):
	...
	description see :class:`mujoco_blueprints.camera.Camera`.
	"""
...
class AgentType(BodyType):
	...
	description see :class:`mujoco_blueprints.agent.Agent`.
	"""
