...
class Material(blue.MaterialType, blue.NodeThing):
	...
	To apply :class:`Textures <mujoco_blueprints.texture.BaseTexture>` to Things, they must be attributes 
	of a Material which in turn is assigned to the Thing. Just keeping the default values for 
	Materials and assigning it to :class:`Sites <mujoco_blueprints.sites.BaseSite>` and 
	:class:`Geoms <mujoco_blueprints.geoms.BaseGeom>` will have no visual effect.
	...
	def __init__(self, 
		...
		texture : blue.TextureType | None, optional
			A :class:`Texture <mujoco_blueprints.texture.BaseTexture>` Thing
		...
		asset : blue.MaterialAssetType | None, optional
			The :class:`Asset <mujoco_blueprints.asset.MaterialAsset>` of the Material
		copy : bool, optional
